...
contract MultiSig {
    ...
    // Add Transaction - yeni işlem ekler (artık internal)
    ...
    // Submit Transaction - transaction oluştur ve hemen onayला
    ...
    // Execute Transaction - onaylanmış transaction'ı çalıştırır
